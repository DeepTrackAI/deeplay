...
def normed_leaky(mlp: MultiLayerPerceptron, in_features=None, out_features=None):

    mlp["blocks", :-1].all.normalized(nn.BatchNorm1d).activated(Layer(nn.LeakyReLU, negative_slope=0.05))
